<?php
    ...
    $path = array(
            "index" => "include/rakugo-index.php",
            "schedule" => "application/rakugo-schedule/schedule.php",
            "master" => "application/master_table/master_table.php",

            "sitemap" => "include/sitemap.php",

            /* Y */
            "pickup" => "application/rakugo-pickup/pickup_home.php",
			"inquery" => "application/rakugo-pickup/inquery.php",
			"send" => "application/rakugo-pickup/form_send.php",
			"pickup_schedule" => "application/rakugo-pickup/pickup_schedule.php",
			"pickup_performe" => "application/rakugo-pickup/pickup_performe.php",
            /* Y */
            //RUN
			"perregistration" => "application/performer/run_perregistration.php",
			"perprofileedit" => "application/performer/run_perprofileedit.php",
			"perprofile" => "application/performer/run_perprofile.php",
			"perpasswordedit" => "application/performer/php_sub/run_passwordedit.php",
			"perlist" => "application/performer/run_perlist.php",
			"permanagement" => "application/performer/run_permanagement.php",
			"logout" => "include/logout.php",
			"term" => "application/term/run_term.php",
			"term1" => "application/term/run_term1.php",
			"term2" => "application/term/run_term2.php",
			"term3" => "application/term/run_term3.php"
			//end RUN
            );
    ...
    function getUserType(){
        $user_id = getCurrentUser();
        if($user_id != 0){
            $user_type = getValue("SELECT per_user_type FROM tbl_performer WHERE performer_id = " . $user_id);
            if($user_type == "administrator") return ADMINISTRATOR;
            else if($user_type == "performer") return PERFORMER;
        }
        return VIEWER;
    }
